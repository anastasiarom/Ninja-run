...
void AnimationManager::draw(RenderWindow& window, int x = 0, int y = 0)      //вывод на экран текущей анимации в координаты x,y
{
...
void AnimationManager::loop(bool l, std::string name) 
{ 
	animList[name].loop = l; 
}